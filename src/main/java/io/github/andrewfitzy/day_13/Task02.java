...
public final class Task02 {
    ...
    public int solve() {
        ...
        for (String person : uniquePeople) {
            Pair lrPair = new Pair(person, ANDREW);
            seatingMap.put(lrPair, 0);
            Pair rlPair = new Pair(ANDREW, person);
            seatingMap.put(rlPair, 0);
        }
        uniquePeople.add(ANDREW);
